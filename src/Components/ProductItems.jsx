import { Box, Button, Divider, Heading, HStack, Image, Spacer } from "@chakra-ui/react"
  ...
  if (type == "guide") {
    ...
    return (
      <Box id={id} textAlign={"left"} >
        ...
        <Image rounded={10} width="95%" src={guide_Img} alt="pic" />
        <br />
      </Box>
    )
  }
    ...
    return (
      <Box display={"flex"} p="10" justifyContent="space-around"  >
        ...
        <Box margin={"auto"} width={"15%"}  >
          <Box  >
            <Box >
              <Image rounded={"10"} width={"100%"} src={img} alt="img" />
